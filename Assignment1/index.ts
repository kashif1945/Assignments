...
var length:number= 10; // variable declearation
var width:number= 20; // variable decleration
var areaOfRectangle:number= length*width; // Area=L*W
...
var cubeSurfaceArea:number= 6*sideLength*sideLength; // Cube Formula : A= 6A^2
