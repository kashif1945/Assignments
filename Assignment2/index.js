...
var obtainMarks = 575;
var totalMarks = 850;
var resultPercentage = obtainMarks / totalMarks * 100;
console.log("Percentage is :", resultPercentage);
//-----------------------------------------------------------------------------------------------------------
//Write a program that converts given number of days in to weeks and days such as 17 days = 2 weeks and 3 days.
//--------------------------------------------------------------------------------------------------------------
let nDays = 35;
let nWeeks = Math.floor(nDays / 7); // function is used to round down the value
let rDays = nDays % 7;
...
var productPrice = 90;
if (productPrice > 100) {
    var discountPrice1 = productPrice - productPrice * (10 / 100);
    console.log(`10% Discounted Price is :  ${discountPrice1}`);
}
else {
    var discountPrice2 = productPrice - productPrice * (5 / 100);
...
var givenNumber = 15;
if (givenNumber % 3 == 0) {
    console.log(givenNumber, `The Given Number is divisible by 3`);
}
else {
